...
$$\begin{aligned}
  \hat k_{t+1} - \lambda_1 \hat k_{t} 
    &= \lambda_2^t (\hat k_1 - \lambda_1 \hat k_0) \\
  \hat k_{t+1} - \lambda_2 \hat k_{t} 
    &= \lambda_1^t (\hat k_1 - \lambda_2 \hat k_0)
\end{aligned}$$
...
$$\hat k_t = \left(\frac{\lambda_1^t - \lambda_2^t}{\lambda_1 - \lambda_2}\right) \hat k_1 + \left( \frac{\lambda_1\lambda_2^t - \lambda_2 \lambda_1^t}{\lambda_1 - \lambda_2}\right) \hat k_0$$
...
$$\begin{bmatrix} \hat k_{t} \\ \hat k_{t+1}\end{bmatrix}
=
\begin{bmatrix}
0 & 1\\
 -\beta^{-1} & - \frac{u_{22}^* + \beta u_{11}^*}{\beta u_{12}^*}
\end{bmatrix}
\begin{bmatrix} \hat k_{t-1} \\ \hat k_{t}\end{bmatrix}$$
...
$$\begin{aligned}
  \hat k_{t+1} - \lambda_1 \hat k_{t} 
    &= \lambda_2^t (\hat k_1 - \lambda_1 \hat k_0) \equiv 0
\end{aligned}$$
となるように $\hat k_1$ がうまく選ばれるからである**
